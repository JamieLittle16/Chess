...
# Record each interior edge before the board is mutated.
...
# Root search edges are deferred too; emergency one-ply fallback remains full rebuild and unchanged.
