...
s=r(old,new,'history context')
s=r('        reduction = _lmr_v3_reduction(depth, index) if lmr_candidate else 0\n','        reduction = _lean_hist_reduction(depth,index,hist_score) if lmr_candidate else 0\n','lmr')
