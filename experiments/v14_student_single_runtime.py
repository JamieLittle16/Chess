"""Incremental absolute768 student runtime for Python V14 generation-2 experiments.

This module is deliberately baseline-agnostic: the trained student returns a White-perspective
centipawn correction and search integration decides whether that correction is applied on top of
qualified V13 or on top of its inexpensive classical core.  The accumulator transport uses scalar
Numba loops, the fastest qualified shape for this runtime.
"""
