#!/usr/bin/env python3
"""Materialize the screened bishop-pair and rook-file evaluator on production main."""
...
text = replace_once(text, "    use chess_core::Position;\n\n    use super::evaluate;", "    use chess_core::{Color, Position};\n\n    use super::{evaluate, piece_structure};", "test imports")
text = replace_once(text, "    #[test]\n    fn endgame_king_is_rewarded_for_centralisation() {", '''    #[test]
    ...
    #[test]
    fn endgame_king_is_rewarded_for_centralisation() {''', "tests")
