#!/usr/bin/env python3
"""Apply the previously tested conservative one-ply LMR policy to current main."""
...
new_probe = '''                // Conservative LMR: only late quiet, non-checking moves receive one ply of
                // reduction. Any reduced alpha improvement is re-searched at full depth before it
                // can affect the node.
