...
# Preserve one clean protocol fd before redirecting candidate stdout to stderr.
...
def reset_agent() -> None:
    """Restore per-game mutable state without throwing away already-JIT-compiled code."""
    required = (
        "_GAME_KEYS",
        "_PENDING_AFTER_OUR_MOVE",
        "_LAST_CALL_TIME_LEFT_MS",
        "_LAST_GET_MOVE_ELAPSED_MS",
        "_CLOCK_OVERHEAD_EMA_MS",
        "_CLOCK_FEEDBACK_SAMPLES",
        "_HASH_KEYS",
        "_HASH_MOVES",
        "_TT_TABLE",
    )
